...
export default function Layout({ children }) {
  ...
  return (
    <div className={`min-h-screen ${isDark ? "bg-[#0a0a0f] text-white" : "bg-[#f0f1f8] text-gray-900"} ${!isRestrictedArea && isLevel1User ? "user-screen-background" : ""} ${!isRestrictedArea && isLevel2User ? "user-screen-background user-screen-background-level-2" : ""} ${!isRestrictedArea && isLevel3User ? "user-screen-background user-screen-background-level-3" : ""} ${!isRestrictedArea && isLevel4User ? "user-screen-background user-screen-background-level-4" : ""} ${!isRestrictedArea && isLevelUser5 ? "user-screen-background user-screen-background-level-5" : ""} ${isLevel1User ? "user-level-1-shell" : ""} ${isLevel2User ? "user-level-2-shell" : ""} ${!isRestrictedArea && isLevel3User ? "user-level-3-shell" : ""}`}>
      ...
      {/* Header */}
      <header className={`sticky top-0 z-50 border-b backdrop-blur-xl ${isLevel3User ? "user-level-3-header" : isDark ? "border-white/5 bg-[#0a0a0f]/80" : "border-gray-200 bg-white/90"} ${isLevel4User ? "user-level-4-header" : isDark ? "border-white/5 bg-[#0a0a0f]/80" : "border-gray-200 bg-white/90"} ${isLevel5User ? "user-level-5-header" : isDark ? "border-white/5 bg-[#0a0a0f]/80" : "border-gray-200 bg-white/90"}`}>
      ...
      <footer className={`border-t py-8 mt-12 ${isDark ? "border-white/5" : "border-gray-200"}`}>
        <div className={`max-w-7xl mx-auto px-4 text-center text-sm ${isLevel5User ? "user-level-5-footer-text" :isLevel4User ? "user-level-4-footer-text" : isLevel2User ? "user-level-2-footer-text" : isDark ? "text-gray-500" : "text-gray-400"}`}>
