...
export default function Home() {
  ...
  return (
    <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 space-y-8 sm:space-y-10 md:space-y-12 ${isLevel1User ? "user-level-1-home" : ""} ${isLevel2User ? "user-level-2-home" : ""} ${isLevel3User ? "user-level-3-home" : ""}`}>
      ...
      <section className={`bg-gradient-to-r from-purple-600/20 to-cyan-600/20 border border-white/10 rounded-2xl md:rounded-3xl p-6 sm:p-8 md:p-12 text-center ${isLevel1User ? "user-level-1-highlight-section" : ""} ${isLevel2User ? "user-level-2-highlight-section" : ""} ${isLevel3User ? "user-level-3-widget" : ""}`}>
