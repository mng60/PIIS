...
export default function Home() {
  ...
  return (
    <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 flex flex-col gap-8 sm:gap-10 md:gap-12 ${isLevel1User ? "user-level-1-home" : ""} ${isLevel2User ? "user-level-2-home" : ""} ${isLevel3User ? "user-level-3-home" : ""} ${isLevel4User ? "user-level-4-home" : ""} ${isLevel5User ? "user-level-5-home" : ""}`}>
      ...
      {featuredGames.length > 0 && (
        <section className="order-2">
          <h2 className={`text-2xl md:text-3xl font-bold text-white mb-6 flex items-center gap-3 ${isLevel1User ? "user-level-1-featured-heading" : ""} ${isLevel2User ? "user-level-2-section-heading" : ""} ${isLevel3User ? "user-level-3-section-heading" : ""} ${isLevel4User ? "user-level-4-section-heading" : ""} ${isLevel5User ? "user-level-5-section-heading" : ""}`}>
