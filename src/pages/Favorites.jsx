...
export default function Favorites() {
  ...
  return (
    <div className={`max-w-7xl mx-auto px-4 py-8 ${isLevel1User ? "user-level-1-favorites-page" : ""} ${isLevel2User ? "user-level-2-favorites-page" : ""} ${isLevel3User ? "user-level-3-favorites-page" : ""} ${isLevel4User ? "user-level-4-favorites-page" : ""} ${isLevel5User ? "user-level-5-favorites-page" : ""}`}>
      <div className="mb-8">
